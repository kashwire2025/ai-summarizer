...
export default function LoginPage() {
  ...
  return (
    <main className="min-h-screen bg-[#0b101d] text-white flex items-center justify-center p-4">
      <div className="bg-[#131b2e] border border-slate-800 p-8 rounded-2xl max-w-sm w-full text-center space-y-6">
        <h1 className="text-2xl font-bold">Welcome Back</h1>
        <p className="text-sm text-slate-400">Sign in to access your saved summaries and history</p>
